<template>
  ...
  <div v-else>
    <HeaderPiece numero_piece="19" :numero_dossier="dao.numero_appel_offre" :moe="dao.maitre_ouvrage" :description_travaux="dao.objet_appel"/>
    ...
    <div class="form-container mt-4">
      <div style="padding:0px 100px;">
        <PDF src="/modeles_pieces/PROCEDURE_SOUMISSION_EN_LIGNE_CR.pdf" />
      </div>
    </div>
  </div>
