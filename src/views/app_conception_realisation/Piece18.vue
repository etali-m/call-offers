<template>
  ...
  <div v-else>
    <HeaderPiece numero_piece="18" :numero_dossier="dao.numero_appel_offre" :moe="dao.maitre_ouvrage" :description_travaux="dao.objet_appel"/>
    ...
    <div class="form-container mt-4">
      <div style="padding:0px 100px;">
        <PDF src="/modeles_pieces/LISTE_BANQUES.pdf" />
      </div>
    </div>
  </div>
